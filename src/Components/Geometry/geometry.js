...
import { BoxGeometry, ConeGeometry, CylinderGeometry, TorusGeometry, SphereGeometry, TorusKnotGeometry, RingGeometry, CapsuleGeometry, DodecahedronGeometry, IcosahedronGeometry, OctahedronGeometry, TetrahedronGeometry, PolyhedronGeometry, TubeGeometry, CircleGeometry, EdgesGeometry, ExtrudeGeometry, LatheGeometry, PlaneGeometry, Shape, WireframeGeometry } from 'three';
import { StandardGeometryTypes } from "../../Configs/types";

const generateParams = (type, props) => {
  switch (type) {
    ...
    case StandardGeometryTypes.PolyhedronGeometry:
      return [props.vertices, props.indices, props.radius, props.detial];
...
const Geometry = ({type, ...props}) => {
  const params = generateParams(type, props);
  switch (type) {
    case StandardGeometryTypes.BoxGeometry:
